...
$query = "INSERT INTO usuarios (desactivar, nombre, apellido, cedula, usuario, rol, contrasena, codigo, correo, telefono, facultad, programa, cursos, matriculado) VALUES ('".$desactivar."','".$nombre."','".$apellido."','".$cedula."','".$usuario."','".$rol."','".$contrasena."','".$codigo."','".$correo."','".$telefono."','".$facultad."','".$programa."','".$cursos."','".$matriculado."')";
